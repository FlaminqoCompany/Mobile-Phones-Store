...
<body style="font-family: var(--e-global-typography-text-font-family);">
    ...
    <div style="width: 100%">
        ...
        <div class="w-100 row p-2" style="height: 40%; border-bottom: 1px solid lightgrey">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 d-inline-block d-flex pl-xl-3 pl-lg-3 pl-md-4 pl-sm-4 pl-4"><h1 class="box w-100 text-xl-left text-lg-left text-md-left text-sm-center text-center">LOGO<h1></div>
            ...
            <div class="pt-3 pb-0 pr-0 pl-0 col-xl-2 col-lg-2 d-xl-inline-block d-lg-inline-block d-md-none d-sm-none d-none" >
                <div style="width: 120px; display: block; float:right;">
                    ...
                    <img src="images/bag.png" style="width: 25px" class="user_heart_bag" alt="">
                </div>
        ...
        <div class="w-100 row  p-md-2 p-sm-3 p-3 d-xl-none d-lg-none">
            <div class="col-md-6 col-sm-3 col-3">
                <img src="images/menu.png" class="pl-3 menu_bag" alt="">
            </div>
            ...
            <div class="col-md-6 col-sm-3 col-3">
                <img src="images/bag.png" style="float: right" class="pl-3 menu_bag" alt="">
            </div>
        </div>
    </div>
